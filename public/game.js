...
(function(){
  ...
  const phrasePairs=[
    ["Felhasználónév","Username"],["Jelszó","Password"],["Belépés","Login"],["Regisztráció","Register"],
    ["A gép még pörög.","The machine is still spinning."],
    ["A tét","The bet"],["között lehet.","must be within the allowed range."],
    ["Nincs elég valutád.","Not enough currency."],["Nincs elég játékbeli valutád.","Not enough in-game currency."],
    ["Ingyen pörgetés","Free Spin"],["INGYEN PÖRGETÉS","FREE SPIN"],["Pörgetés","Spin"],["PÖRGETÉS","SPIN"],
    ["NYEREMÉNY","WIN"],["VESZTESÉG","LOSS"],["VESZTETTÉL","YOU LOST"],["SÁRKÁNY JACKPOT","DRAGON JACKPOT"],
    ["Összes kill","Total Kills"],["Összerő","Total Power"],["Összes arany","Total Gold"],["Talált tárgy","Items Found"],
    ["Legendás drop","Legendary Drops"],["Játékidő","Play Time"],["Az első újjászületés","First Rebirth"],
    ["Sebzés %","Damage %"],["A teljes sebzésedet növeli.","Increases your total damage."],
    ["Nincs elég arany az opciók forgatásához.","Not enough gold to reroll options."],
    ["opciói újraforgatva.","options rerolled."],["Inventory tele","Inventory full"],["tárgy automatikusan eladva.","item automatically sold."],
    ["BOSS megjelent! Nem léphetsz tovább, amíg le nem győzöd.","BOSS appeared! You cannot advance until it is defeated."],
    ["legyőzve","defeated"],["arany","gold"],["Legendás arany aura","Legendary Gold Aura"],["Mythic bíbor aura","Mythic Crimson Aura"],
    ["ERŐ","POWER"],["sloton felraktam a legerősebb tárgyat.","slots equipped with the strongest item."],
    ["Már a legjobb felszerelések vannak rajtad.","You already have the best equipment equipped."],
    ["Nincs törölhető","No deletable"],["tárgy.","item."],["Biztosan törlöd az összes NEM felszerelt","Are you sure you want to delete all UNEQUIPPED"],
    ["tárgy törlődik.","items will be deleted."],["tárgy törölve.","items deleted."],
    ["Nincs eladható","No sellable"],["Eladod az összes NEM felszerelt","Sell all UNEQUIPPED"],
    ["tárgy eladva","items sold"],["Előfeltétel","Prerequisite"],["Harci ág","Combat Branch"],["Farm ág","Farm Branch"],
    ["AFK ág","AFK Branch"],["Pet ág","Pet Branch"],["Kell:","Required:"],["lélekkő","Soul Stone"],
    ["ÁTVÁLTÁS","CONVERT"],["NINCS ELÉG ARANY","NOT ENOUGH GOLD"],["Szükséges:","Required:"],
    ["csomag","bundle"],["választás megmaradt.","selection has been saved."],["opció","option"],
    ["óra","hours"],["perc","minutes"],["FELSZERELÉS","EQUIPMENT"],["FOGYÓESZKÖZ","CONSUMABLE"],
    ["NINCS ELÉG VALUTA","NOT ENOUGH CURRENCY"],["Ez az ajánlat elfogyott.","This offer is sold out."],
    ["Megvásárolva","Purchased"],["Automata farm külön gyűjtve","Auto-farm collected separately"],
    ["Automata farm","Auto Farm"],["arany hozzáadva!","gold added!"],["Még nincs felszerelhető peted.","You do not have an equippable pet yet."],
    ["Már a legerősebb petek vannak felszerelve.","The strongest pets are already equipped."],
    ["legerősebb pet felszerelve!","strongest pets equipped!"],["Levétel","Unequip"],["Nincs több szabad pet hely.","No free pet slots left."],
    ["Pet levéve","Pet unequipped"],["pet idézési ára","pet summon cost"],["pet megidézve","pets summoned"],
    ["Dungeon teljesítve!","Dungeon completed!"],["Átvétel","Claim"],["KEVÉS PONT","NOT ENOUGH POINTS"],
    ["Küldetés jutalom átvéve","Quest reward claimed"],["felszerelés cserélve.","equipment pieces replaced."],
    ["Wave végén","At the end of the Wave"],["KELL MÉG","STILL NEED"],["PARAGON","PARAGON"],
    ["Paragon szintlépés elérhető!","Paragon level-up available!"],["wave kell a következő Paragon szinthez.","waves needed for the next Paragon level."],
    ["Követelmény:","Requirement:"],["Paragon statok hatásszorzója","Paragon stat effect multiplier"],
    ["PARAGON SZINTLÉPÉS","PARAGON LEVEL UP"],["Megvásárlás","Purchase"],["Következő Paragon követelmény","Next Paragon requirement"],
    ["Sebzés statpont most","Damage stat point now gives"],["-ot ad.","."],["Elérted a Prestige 100 maximumot!","You reached the Prestige 100 maximum!"],
    ["Prestige","Prestige"],["követelménye","requirement"],["Nincs felszerelt tárgy","No item equipped"],["Ár:","Price:"],
    ["A boss automatikusan jön minden wave végén.","A boss automatically appears at the end of every wave."],
    ["normál tárgy eladva","normal items sold"],["Biztosan TELJESEN törlöd a játékmentést?","Are you sure you want to COMPLETELY delete your game save?"],
    ["Vendég","Guest"],["Felhő mentés","Cloud Save"],["Egy valuta elérte a szerver gazdasági maximumát.","A currency reached the server economy maximum."],
    ["Admin jutalom / módosítás megérkezett!","Admin reward / change received!"],["Felhőbe mentve","Saved to Cloud"],
    ["Mentési hiba","Save Error"],["belépés","login"],["regisztráció","registration"],["Mentés...","Saving..."],["Helyi mentés","Local Save"],
    ["PARAGON ELÉRHETŐ","PARAGON AVAILABLE"],["UTOLSÓ TERÜLET FARM","FINAL AREA FARM"],["JUTALOM","REWARD"],
    ["TELJES FARMJUTALOM","FULL FARM REWARD"],["PARAGON CÉL","PARAGON TARGET"],["MINDEN VALÓDI TÁRGY MAX","ALL REAL ITEMS MAXED"],
    ["Következő közös kör","Next shared round"],["Nincs fejleszthető valódi felszerelés","No real equipment can be upgraded"],
    ["A 10× sebesség prémium.","10× speed is premium."],["Az aktuális ára a Feltöltés fülön látható.","Its current price is shown on the E-Coin tab."],
    ["Harci / Wave sebesség","Combat / Wave Speed"],["Nincs aktiválva","Not Activated"],["Aktuális HP-terhelés","Current HP load"],
    ["RITKA HASADÉK BOSS érkezett!","RARE RIFT BOSS appeared!"],["Legyőzve garantált +5 wave.","Defeat it for a guaranteed +5 Waves."],
    ["BOSS érkezett! Ha legyőz, ezt a wave-et újra kell kezdened.","BOSS appeared! If it defeats you, you must restart this Wave."],
    ["Farm aktivitás: fejlessz tárgyat vagy teljesíts dungeont!","Farm activity: upgrade an item or complete a dungeon!"],
    ["teljesítve! Következő","completed! Next"],["Farm aktivitása még nincs teljesítve.","Farm activity is not completed yet."],
    ["Boss legyőzve!","Boss defeated!"],["WAVE UGRÁS","WAVE SKIP"],["A Paragon elérhető; az utolsó területen tovább farmolhatsz 100% jutalommal.","Paragon is available; you can keep farming the final area with 100% rewards."],
    ["mérföldkő","milestone"],["kristály","crystals"],["A Boss legyőzött!","The Boss defeated you!"],
    ["Már MAX HP-n vagy","You are already at MAX HP"],["múlva újraindul a wave.","until the Wave restarts."],
    ["Legyőztek!","You were defeated!"],["MAX HP-val éledtél újra","You revived with MAX HP"],
    ["védelem után folytatódik a farm.","protection, then farming continues."],["Nincs elég arany a HP Regen fejlesztéshez.","Not enough gold to upgrade HP Regen."],
    ["Újraéledtél. Az automata harc folytatódik.","You revived. Auto combat continues."],["Újraéledési védelem","Respawn Protection"],
    ["csökk.","reduction"],["blokk","block"],["AKTÍV NYÍLVESSZŐ","ACTIVE ARROW"],["lövés","shots"],["sebzés","damage"],
    ["Nincs aktív harci nyílvessző","No active combat arrow"],["Új terület","New Area"],["Szörny","Monster"],["Egyedi tárgy","Unique Item"],
    ["elesett, de a Wave","was defeated, but Wave"],["Nem léphetsz tovább","You cannot advance"],["amíg le nem győzöd","until you defeat it"],
    ["ZÁROLVA","LOCKED"],["Átvéve","Claimed"],["Kritikus találat","Critical Hit"],["Páncél","Armor"],["Kesztyű","Gloves"],["Gyűrű","Ring"],
    ["Árnyékpárduc","Shadow Panther"],["Démon torony","Demon Tower"],["Sárkány-völgy","Dragon Valley"],["Kezdők barlangja","Beginner Cave"],
    ["Elfeledett bánya","Forgotten Mine"],["Bányarém","Mine Horror"],["Mélység ura","Lord of the Abyss"],
  ...
  function translateText(raw){
    ...
    const generic=[
      ["játékos","player"],["Játékos","Player"],["játék","game"],["Játék","Game"],
      ["terület","area"],["Terület","Area"],["tárgy","item"],["Tárgy","Item"],
      ["felszerelt","equipped"],["felszerelés","equipment"],["Felszerelés","Equipment"],
      ["fejlesztés","upgrade"],["Fejlesztés","Upgrade"],["fejleszthető","upgradeable"],
      ["képesség","skill"],["Képesség","Skill"],["jutalom","reward"],["Jutalom","Reward"],
      ["esély","chance"],["Esély","Chance"],["ellenállás","resistance"],["Ellenállás","Resistance"],
      ["támadás","attack"],["Támadás","Attack"],["védelem","defense"],["Védelem","Defense"],
      ["találat","hit"],["Találat","Hit"],["szorzó","multiplier"],["Szorzó","Multiplier"],
      ["ingyenes","free"],["Ingyenes","Free"],["követelmény","requirement"],["Követelmény","Requirement"],
      ["elérhető","available"],["Elérhető","Available"],["szükséges","required"],["Szükséges","Required"],
      ["automatikus","automatic"],["Automatikus","Automatic"],["egyszerre","at once"],["Egyszerre","At Once"],
      ["összes","all"],["Összes","All"],["legjobb","best"],["Legjobb","Best"],["ritka","rare"],["Ritka","Rare"],
      ["gyorsítás","speed boost"],["Gyorsítás","Speed Boost"],["megvásárolva","purchased"],["Megvásárolva","Purchased"],
      ["feloldva","unlocked"],["Feloldva","Unlocked"],["zárolva","locked"],["Zárolva","Locked"],
      ["kör","round"],["Kör","Round"],["küldetés","quest"],["Küldetés","Quest"],
      ["napi","daily"],["Napi","Daily"],["heti","weekly"],["Heti","Weekly"],
      ["érték","value"],["Érték","Value"],["darab","pcs"],["db","pcs"]
    ];
    for(const [hu,en] of generic)out=out.replaceAll(hu,en);
