...
const CASINO_DEFAULTS_V247={minBet:{gold:100,gems:1,ore:5},maxBet:{gold:25000,gems:100,ore:500},games:{coin:{name:"Coin Flip",icon:"🪙",chance:47,mult:1.9,desc:"Fej vagy írás – közel fele esély."},skull:{name:"Koponya",icon:"💀",chance:28,mult:3.2,freeSpinChance:5,freeSpinAmount:1,desc:"Kockázatosabb, nagyobb jutalom."},dragon:{name:"Sárkány Slot",icon:"🐉",chance:8,mult:10,freeSpinChance:3,freeSpinAmount:2,desc:"Ritka jackpot a legnagyobb szorzóval."}}};
